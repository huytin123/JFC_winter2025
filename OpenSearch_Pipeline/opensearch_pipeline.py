...
# Your deployed ML model ID
model_id = "u6KQw5cBa5E3d2biRIhN"

# Create the ingest pipeline
pipeline_body = {
    "description": "Ingest pipeline with text_embedding processor",
    "processors": [
        {
            "text_embedding": {
                "model_id": model_id,
                "field_map": {
                    "text": "text_embedding"  # from → to
                }
            }
        }
    ]
...
query = {
    "size": 3,
    "query": {"knn": {"text_embedding": {"vector": mean_pooled, "k": 3}}},
    "_source": False,
    "fields": ["name"]
}
